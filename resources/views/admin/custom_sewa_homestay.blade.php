...
@section('title','Custom Sewa Homestay')
@section('dash','')
@section('lanpag','')
    ...
    <tbody>
        @foreach($data as $list)
            ...
            <tr>
                ...
                <td>
                    <a href="/edit_sh/{{ $list->id }}"><button type="button" class="btn btn-primary btn-xs dt-edit"
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="simpan_sh" enctype="multipart/form-data">
                @csrf
...
<script>
    function konfirmasi(a) {
        if (confirm('Apakah Anda yakin untuk menghapus data ini?')) {
            window.location.href = "/hapus_sh/" + a;
        }
    }
